...
module.exports = class PauseCommand extends Command {
  ...
  async exec(msg) {
    try {
      ...
      if (!GuildPlayers) return msg.channel.send({ embeds: [CreateEmbed('warn', 'There no music played nowm, peko.')] });
      ...
      return msg.channel.send({ embeds: [CreateEmbed('info', 'ZAWARUDOO!! music paused, peko.')] });
    } catch (e) {
