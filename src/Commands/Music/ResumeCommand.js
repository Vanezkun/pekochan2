...
module.exports = class ResumeCommand extends Command {
  ...
  async exec(msg) {
    try {
      ...
      if (!GuildPlayers) return msg.channel.send({ embeds: [CreateEmbed('info', 'There no music played now, peko.')] });
      ...
      return msg.channel.send({ embeds: [CreateEmbed('info', 'Resumed current song, peko.')] });
    } catch (e) {
